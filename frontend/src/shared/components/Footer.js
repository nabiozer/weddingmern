...
const Footer = () => {
  ...
  return (
    <footer className="footer-container">
      ...
      <a href="https://www.instagram.com/nnphotofilm/" target="_blank" rel="noopener"><i className="fa-brands fa-instagram"></i></a>
    
      <a href="https://api.whatsapp.com/send/?phone=905421132503&text&app_absent=0" target="_blank" rel="noopener"><i className="fa-brands fa-whatsapp"></i></a> 
      </div>
